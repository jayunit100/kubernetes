...
var _ = network.SIGDescribe("Netpol [LinuxOnly]", func() {
	...
	ginkgo.Context("NetworkPolicy between server and client", func() {
		ginkgo.BeforeEach(func() {
			...
			ValidateOrFail(k8s, &TestCase{FromPort: 83, ToPort: 80, Protocol: v1.ProtocolTCP, Reachability: NewReachability(GetAllPods(), true)}, true)
			ValidateOrFail(k8s, &TestCase{FromPort: 83, ToPort: 81, Protocol: v1.ProtocolTCP, Reachability: NewReachability(GetAllPods(), true)}, true)
		})
		...
		ginkgo.It("should support a 'default-deny-ingress' policy [Feature:Netpol]", func() {
			...
			ValidateOrFail(k8s, &TestCase{FromPort: 82, ToPort: 80, Protocol: v1.ProtocolTCP, Reachability: reachability}, true)
		})
		...
		ginkgo.It("should enforce multiple, stacked policies with overlapping podSelectors [Feature:Netpol]", func() {
			...
			ValidateOrFail(k8s, &TestCase{FromPort: 82, ToPort: 81, Protocol: v1.ProtocolTCP, Reachability: reachabilityALLOW}, true)
			...
			ValidateOrFail(k8s, &TestCase{FromPort: 82, ToPort: 80, Protocol: v1.ProtocolTCP, Reachability: reachabilityDENY}, true)
			...
			ValidateOrFail(k8s, &TestCase{FromPort: 82, ToPort: 80, Protocol: v1.ProtocolTCP, Reachability: reachabilityALLOW}, true)
		})
		...
		ginkgo.It("should allow ingress access on one named port [Feature:Netpol]", func() {
			...
			ValidateOrFail(k8s, &TestCase{FromPort: 82, ToPort: 81, Protocol: v1.ProtocolTCP, Reachability: reachabilityPort81}, true)
			...
			ValidateOrFail(k8s, &TestCase{FromPort: 82, ToPort: 80, Protocol: v1.ProtocolTCP, Reachability: reachabilityPort80}, true)
		})
		...
		ginkgo.It("should allow ingress access from namespace on one named port [Feature:Netpol]", func() {
			...
			ValidateOrFail(k8s, &TestCase{FromPort: 82, ToPort: 81, Protocol: v1.ProtocolTCP, Reachability: reachabilityFAIL}, true)
		})
		...
		ginkgo.It("should enforce updated policy [Feature:Netpol]", func() {
			...
			reachabilityDeny.AllowLoopback()
			ValidateOrFail(k8s, &TestCase{FromPort: 82, ToPort: 81, Protocol: v1.ProtocolTCP, Reachability: reachabilityDeny}, true)
		})
		...
		ginkgo.It("should allow ingress access from updated namespace [Feature:Netpol]", func() {
			...
			ValidateOrFail(k8s, &TestCase{FromPort: 82, ToPort: 80, Protocol: v1.ProtocolTCP, Reachability: reachabilityWithLabel}, true)
		})
		...
		ginkgo.It("should deny ingress access to updated pod [Feature:Netpol]", func() {
			...
			ValidateOrFail(k8s, &TestCase{FromPort: 82, ToPort: 80, Protocol: v1.ProtocolTCP, Reachability: reachabilityIsolated}, true)
		})
		...
		ginkgo.It("should enforce multiple ingress policies with ingress allow-all policy taking precedence [Feature:Netpol]", func() {
			...
			ValidateOrFail(k8s, &TestCase{FromPort: 82, ToPort: 81, Protocol: v1.ProtocolTCP, Reachability: reachabilityAll}, true)
		})
		...
		ginkgo.It("should stop enforcing policies after they are deleted [Feature:Netpol]", func() {
			...
			reachabilityAll := NewReachability(GetAllPods(), true)
			ValidateOrFail(k8s, &TestCase{FromPort: 82, ToPort: 80, Protocol: v1.ProtocolTCP, Reachability: reachabilityAll}, true)
		})
		...
		ginkgo.It("should enforce policies to check ingress and egress policies can be controlled independently based on PodSelector [Feature:Netpol]", func() {
			...
			*/
			...
			ValidateOrFail(k8s, &TestCase{FromPort: 82, ToPort: 80, Protocol: v1.ProtocolTCP, Reachability: allowEgressReachability}, true)
			...
			ValidateOrFail(k8s, &TestCase{FromPort: 82, ToPort: 80, Protocol: v1.ProtocolTCP, Reachability: denyIngressToXReachability}, true)
		})
