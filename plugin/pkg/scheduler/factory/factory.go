...
func NewConfigFactory(client clientset.Interface, schedulerName string, hardPodAffinitySymmetricWeight int, failureDomainsCString string) scheduler.SchedulerSupportFunctions {
