...
var map_PodSpec = map[string]string{
	...
	"schedulingMismatchedPredicateResults": "SchedulingMismatchedPredicateResults Summary of false podFitsOnNode predicates for investigating unscheduled pods.",
}
