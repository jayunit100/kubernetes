...
func (x codecSelfer1234) decSliceDeployment(v *[]Deployment, d *codec1978.Decoder) {
	...
	if yyl1625 == 0 {
		...
		if yyl1625 > cap(yyv1625) {
			...
			yyv21625 := yyv1625
			yyrl1625, yyrt1625 = z.DecInferLen(yyl1625, z.DecBasicHandle().MaxInitLen, 872)
			if yyrt1625 {
...
func (x codecSelfer1234) decSliceDaemonSet(v *[]DaemonSet, d *codec1978.Decoder) {
	...
	if yyl1631 == 0 {
		...
		if yyl1631 > cap(yyv1631) {
			...
			yyv21631 := yyv1631
			yyrl1631, yyrt1631 = z.DecInferLen(yyl1631, z.DecBasicHandle().MaxInitLen, 768)
			if yyrt1631 {
...
func (x codecSelfer1234) decSliceReplicaSet(v *[]ReplicaSet, d *codec1978.Decoder) {
	...
	if yyl1667 == 0 {
		...
		if yyl1667 > cap(yyv1667) {
			...
			yyv21667 := yyv1667
			yyrl1667, yyrt1667 = z.DecInferLen(yyl1667, z.DecBasicHandle().MaxInitLen, 816)
			if yyrt1667 {
